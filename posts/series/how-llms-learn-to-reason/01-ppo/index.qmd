...
Most treatments of PPO either start with MDPs and Bellman equations and lose you in the abstract before the algorithm appears, or treat PPO as a black box. Neither helps when you actually want to understand it. PPO [@schulman_etal_2017] is REINFORCE with five fixes that, together, solve two problems.
...
The critic judges rather than acts. Taken together, the actor and critic give an *actor-critic* architecture, of which PPO is one specific instance.
