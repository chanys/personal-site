...
BERT [@devlin_etal_2019] changed the modeling. It did not change the labor. The pipeline shape stayed identical to the pre-BERT pipeline; the component models got better:
