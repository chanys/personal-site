...
GRPO itself wasn't new in 2025. The DeepSeek team had introduced it a year earlier, in their DeepSeekMath paper [@shao_etal_2024], where they used it to train a 7B math-specialist model. What changed in 2025 wasn't the algorithm. It was the demonstration that the same algorithm could produce general reasoning capability at frontier scale.
